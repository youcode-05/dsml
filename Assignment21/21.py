...
def kmeans_clustering(data, k=3, iterations=10):
    ...
    for i in range(iterations):
        ...
        # We use numpy broadcasting: data is (150, 1, 4), centroids is (1, k, 4)
...
# Run the algorithm with K=4 as requested
k_value = 4
num_iterations = 10
final_centroids, final_labels = kmeans_clustering(X, k=k_value, iterations=num_iterations)

print("-" * 30)
print(f"Final Results after {num_iterations} iterations (K={k_value})")
print("-" * 30)
